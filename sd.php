<!DOCTYPE html>
  <html>
    ...
    <link href="admin/css/style.css" type="text/css" rel="stylesheet" media="screen,projection">
      ...
      var customIcons = {
      'sd': {
         icon: 'http://localhost/fixmagang/images/iconkra/sd.png'
      }
      };
      ...
      downloadUrl("generatesd.php", function(data) {
      ...
      for (var i = 0; i < markers.length; i++) {
       ...
       var foto = 
        '<img src="./admin/images/pendidikan/'+markers[i].getAttribute("foto")+'" alt="FOTO" width="100px" height="100px" />';
