  ...
  <html>
    ...
    <link href="admin/css/style.css" type="text/css" rel="stylesheet" media="screen,projection">
      ...
      'Kantor Desa/ Kelurahan': {
         icon: 'http://localhost/fixmagang/images/iconkra/kelurahan.png'
      }
      };
      ...
      downloadUrl("generatekelurahan.php", function(data) {
      ...
      for (var i = 0; i < markers.length; i++) {
        ...
        var html = "<b>" + name + "</b> <br/>" + point + "<br/>" + adress + "</br>" + type + "</br>";
