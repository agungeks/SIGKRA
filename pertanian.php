<!DOCTYPE html>
  <html>
    ...
    <link href="admin/css/style.css" type="text/css" rel="stylesheet" media="screen,projection">
      ...
      var customIcons = {
      'tokopupuk': {
         icon: 'http://localhost/fixmagang/images/iconkra/tokopupuk.png'
      }
      };
      ...
      downloadUrl("generatepupuk.php", function(data) {
      ...
      for (var i = 0; i < markers.length; i++) {
        ...
        var foto = '<img src="./admin/images/pertanian/'+markers[i].getAttribute("foto")+'" alt="FOTO"/>';
        
        var sumber = markers[i].getAttribute("sumber");
        var type = markers[i].getAttribute("type");

        //var html = "<b>" + name + "</b> <br/>" + address;
        var html = "<b>" + name + "</b> <br/>" + point + "<br/>" + alamat + "</br>" + type + "</br>"+ info + "</br>"+"</br>"+ sumber + "</br>";
        ...
        bindInfoWindow(marker, map, infoWindow, html,foto);
      }
      });
      }

      function bindInfoWindow(marker, map, infoWindow, html,foto) {
      google.maps.event.addListener(marker, 'click', function() {
      infoWindow.setContent(html+foto);
