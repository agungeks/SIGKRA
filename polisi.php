<!DOCTYPE html>
  <html>
    ...
    <link href="admin/css/style.css" type="text/css" rel="stylesheet" media="screen,projection">
      ...
      var customIcons = {
      'polisi': {
         icon: 'http://localhost/fixmagang/images/iconkra/polisi.png'
      }
      };
      ...
      downloadUrl("generatepolisi.php", function(data) {
      ...
      for (var i = 0; i < markers.length; i++) {
        ...
        var foto = 
        '<img src="./admin/images/keamanan/'+markers[i].getAttribute("foto")+'" alt="FOTO" width="100px" height="100px" />';
