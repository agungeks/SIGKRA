<!DOCTYPE html>
  <html>
    ...
    <link href="admin/css/style.css" type="text/css" rel="stylesheet" media="screen,projection">
      ...
      var customIcons = {
      'koperasi': {
         icon: 'http://localhost/fixmagang/images/iconkra/koperasi.png'
      }
      };
      ...
      downloadUrl("generatekoperasi.php", function(data) {
      ...
      for (var i = 0; i < markers.length; i++) {
        ...
        var type = markers[i].getAttribute("type");
             ...
             var foto = 
        '<img src="./admin/images/ekonomi/'+markers[i].getAttribute("foto")+'" alt="FOTO" width="100px" height="100px" />';
