<!DOCTYPE html>
  <html>
    ...
    <link href="admin/css/style.css" type="text/css" rel="stylesheet" media="screen,projection">
      ...
      var customIcons = {
      'pariwisata': {
         icon: 'http://localhost/fixmagang/images/iconkra/pariwisata.png'
      }
      };
      ...
      downloadUrl("generatepariwisata.php", function(data) {
      ...
      for (var i = 0; i < markers.length; i++) {
        ...
        var foto = 
        '<img src="./admin/images/insfraktuktur/'+markers[i].getAttribute("foto")+'" alt="FOTO" width="100px" height="100px" />';
