...
<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT namaekonomi, alamat, info, lng, type, sumber, lat, foto FROM ekonomi WHERE idekonomi =:uid');
	...
	{
		$namaekonomi = $_POST['namaekonomi'];// user name
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE ekonomi 
									     SET namaekonomi=:unama, 
										     alamat=:ualamat, 
                                             info=:uinfo,  
										     type=:utype,  
										     lng=:ulng, 
										     ...
										     foto=:ufoto 
								       WHERE idekonomi=:uid');
			$stmt->bindParam(':unama',$namaekonomi);
	...
	?>
                ...
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Form Edit Ekonomi</h4>
                    <div class="row">
                      <form class="col s12" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="nama" type="text" name="namaekonomi" value="<?php echo $namaekonomi;?>">
                            <label>Nama Ekonomi</label>
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                        ...
                        <div class="file-field input-field col s12">
	                        ...
	                        <img src="images/ekonomi/<?php echo $foto; ?>" width="90px" height="90px" />
	                        <div class="btn">
	                          <span>Foto</span>
