...
<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT namapendidikan, alamat, info, lng, type, sumber, lat, foto FROM pendidikan WHERE idpendidikan =:uid');
	...
	{
		$namapendidikan = $_POST['namapendidikan'];// user name
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE pendidikan 
									     SET namapendidikan=:unama, 
										     alamat=:ualamat, 
                                             info=:uinfo,  
										     type=:utype,  
										     lng=:ulng, 
										     ...
										     sumber=:usumber, 
										     foto=:ufoto 
								       WHERE idpendidikan=:uid');
			$stmt->bindParam(':unama',$namapendidikan);
	...
	?>
                ...
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Form Edit pendidikan</h4>
                    <div class="row">
                      <form class="col s12" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="nama" type="text" name="namapendidikan" value="<?php echo $namapendidikan;?>">
                        ...
                        <div class="file-field input-field col s12">
	                        ...
	                        <img src="images/pendidikan/<?php echo $foto; ?>" width="90px" height="90px" />
	                        <div class="btn">
	                          <span>Foto</span>
