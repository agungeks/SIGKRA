...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        if(empty($nama)){
            $errMSG = "Masukan Nama kesehatan";
        }
        else if(empty($alamat)){
            $errMSG = "Masukan Alamat kesehatan";
        }
        else if(empty($type)){
            $errMSG = "Masukan Type kesehatan";
        }
        else if(empty($imgFile)){
            $errMSG = "Mohon upload foto kesehatan";
        }
        else
        {
        ...
        if(!isset($errMSG))
        {
            $stmt = $DB_con->prepare('INSERT INTO kesehatan(namakesehatan,alamat,info,type,sumber,lng,lat,foto) VALUES(:unama, :ualamat, :uinfo, :utype, :usumber, :ulng, :ulat, :ufoto)');
            ...
            if($stmt->execute())
            {
                ...
                header("refresh:3;kesehatan.php"); // redirects image view page after 5 seconds.
            }
            else
            {
    ...
    ?> 
                ...
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Form Input kesehatan</h4>
                    <div class="row">
                      <form class="col s12" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="name" type="text" name="sumber" value="<?php echo $sumber; ?>" >
