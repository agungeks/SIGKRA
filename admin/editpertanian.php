...
<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT namapertanian, alamat, info, lng, type, sumber, lat, foto FROM pertanian WHERE idpertanian =:uid');
	...
	{
		$namapertanian = $_POST['namapertanian'];// user name
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE pertanian 
									     SET namapertanian=:unama, 
										     alamat=:ualamat, 
                                             info=:uinfo,  
										     type=:utype,  
										     lng=:ulng, 
										     ...
										     sumber=:usumber, 
										     foto=:ufoto 
								       WHERE idpertanian=:uid');
			$stmt->bindParam(':unama',$namapertanian);
			...
			if($stmt->execute()){
				...
				window.location.href='pertanian.php';
				</script>
                <?php
			}
			else{
	...
	?>
                ...
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Form Edit pertanian</h4>
                    <div class="row">
                      <form class="col s12" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="nama" type="text" name="namapertanian" value="<?php echo $namapertanian;?>">
                            <label>Nama pertanian</label>
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                       ...
                       <div class="row">
                        ...
                        <div class="file-field input-field col s12">
	                        ...
	                        <img src="images/pertanian/<?php echo $foto; ?>" width="90px" height="90px" />
	                        <div class="btn">
	                          <span>Foto</span>
