...
<?php
    ...
    {
        $nama = $_POST['namapendidikan'];// user name
        ...
        if(empty($nama)){
            $errMSG = "Masukan Nama pendidikan";
        }
        else if(empty($alamat)){
            $errMSG = "Masukan Alamat pendidikan";
        }
        else if(empty($type)){
            $errMSG = "Masukan Type pendidikan";
        }
        else if(empty($imgFile)){
            $errMSG = "Mohon upload foto pendidikan";
        }
        else
        {
            $upload_dir = 'images/pendidikan/'; // upload directory
        ...
        if(!isset($errMSG))
        {
            $stmt = $DB_con->prepare('INSERT INTO pendidikan(namapendidikan,alamat,info,type,sumber,lng,lat,foto) VALUES(:unama, :ualamat, :uinfo, :utype, :usumber, :ulng, :ulat, :ufoto)');
            ...
            if($stmt->execute())
            {
                ...
                header("refresh:1;pendidikan.php"); // redirects image view page after 5 seconds.
            }
            else
            {
    ...
    ?> 
                ...
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Form Input pendidikan</h4>
                    <div class="row">
                      <form class="col s12" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="name" type="text" name="namapendidikan" value="<?php echo $username; ?>" >
