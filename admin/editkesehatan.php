...
<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT namakesehatan, alamat, info, lng, type, sumber, lat, foto FROM kesehatan WHERE idkesehatan =:uid');
	...
	{
		$namakesehatan = $_POST['namakesehatan'];// user name
		...
		if($imgFile)
		{
			$upload_dir = 'images/kesehatan/'; // upload directory	
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE kesehatan 
									     SET namakesehatan=:unama, 
										     alamat=:ualamat, 
                                             info=:uinfo,  
										     type=:utype,  
										     lng=:ulng, 
										     ...
										     sumber=:usumber, 
										     foto=:ufoto 
								       WHERE idkesehatan=:uid');
			$stmt->bindParam(':unama',$namakesehatan);
	...
	?>
                ...
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Form Edit kesehatan</h4>
                    <div class="row">
                      <form class="col s12" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="nama" type="text" name="namakesehatan" value="<?php echo $namakesehatan;?>">
                        ...
                        <div class="row">
                          <div class="input-field col s12">
                            ...
                            <option value="apotek">Apotik</option>
                        ...
                        <div class="file-field input-field col s12">
	                        ...
	                        <img src="images/kesehatan/<?php echo $foto; ?>" width="90px" height="90px" />
	                        <div class="btn">
	                          <span>Foto</span>
