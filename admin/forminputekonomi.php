...
<?php
    ...
    {
        $nama = $_POST['namaekonomi'];// user name
        ...
        if(empty($nama)){
            $errMSG = "Masukan Nama Ekonomi";
        }
        else if(empty($alamat)){
            $errMSG = "Masukan Alamat Ekonomi";
        }
        else if(empty($type)){
            $errMSG = "Masukan Type Ekonomi";
        }
        else if(empty($imgFile)){
            $errMSG = "Mohon upload foto Ekonomi";
        }
        else
        {
            $upload_dir = 'images/ekonomi/'; // upload directory
        ...
        if(!isset($errMSG))
        {
            $stmt = $DB_con->prepare('INSERT INTO ekonomi(namaekonomi,alamat,info,type,sumber,lng,lat,foto) VALUES(:unama, :ualamat, :uinfo, :utype, :usumber, :ulng, :ulat, :ufoto)');
            ...
            if($stmt->execute())
            {
                ...
                header("refresh:3;ekonomi.php"); // redirects image view page after 5 seconds.
            }
            else
            {
    ...
    ?> 
                ...
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Form Input Ekonomi</h4>
                    <div class="row">
                      <form class="col s12" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="name" type="text" name="namaekonomi" value="<?php echo $username; ?>" >
