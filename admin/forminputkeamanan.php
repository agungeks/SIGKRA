...
<?php
    ...
    {
        $nama = $_POST['namakeamanan'];// user name
        ...
        if(empty($nama)){
            $errMSG = "Masukan Nama keamanan";
        }
        else if(empty($alamat)){
            $errMSG = "Masukan Alamat keamanan";
        }
        else if(empty($type)){
            $errMSG = "Masukan Type keamanan";
        }
        else if(empty($imgFile)){
            $errMSG = "Mohon upload foto keamanan";
        }
        else
        {
            $upload_dir = 'images/keamanan/'; // upload directory
        ...
        if(!isset($errMSG))
        {
            $stmt = $DB_con->prepare('INSERT INTO keamanan(namakeamanan,alamat,info,type,sumber,lng,lat,foto) VALUES(:unama, :ualamat, :uinfo, :utype, :usumber, :ulng, :ulat, :ufoto)');
            ...
            if($stmt->execute())
            {
                ...
                header("refresh:3;keamanan.php"); // redirects image view page after 5 seconds.
            }
            else
            {
    ...
    ?> 
                ...
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Form Input Keamanan</h4>
                    <div class="row">
                      <form class="col s12" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="name" type="text" name="namakeamanan" value="<?php echo $username; ?>" >
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                          <div class="input-field col s12">
                            ...
                            <option value="polisi">Pos Polisi</option>
                            <option value="tni">Pos Tni</option>
                            </select>
