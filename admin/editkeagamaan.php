...
<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT namakeagamaan, alamat, info, lng, type, sumber, lat, foto FROM keagamaan WHERE idkeagamaan =:uid');
	...
	{
		$namakeagamaan = $_POST['namakeagamaan'];// user name
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE keagamaan 
									     SET namakeagamaan=:unama, 
										     alamat=:ualamat, 
                                             info=:uinfo,  
										     type=:utype,  
										     lng=:ulng, 
										     ...
										     sumber=:usumber, 
										     foto=:ufoto 
								       WHERE idkeagamaan=:uid');
			$stmt->bindParam(':unama',$namakeagamaan);
			...
			if($stmt->execute()){
				...
				window.location.href='keagamaan.php';
				</script>
                <?php
			}
			else{
	...
	?>
                ...
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Form Edit keagamaan</h4>
                    <div class="row">
                      <form class="col s12" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="nama" type="text" name="namakeagamaan" value="<?php echo $namakeagamaan;?>">
                            <label>Nama keagamaan</label>
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                        ...
                        <div class="file-field input-field col s12">
	                        ...
	                        <img src="images/keagamaan/<?php echo $foto; ?>" width="90px" height="90px" />
	                        <div class="btn">
	                          <span>Foto</span>
