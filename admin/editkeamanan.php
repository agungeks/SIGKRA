...
<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT namakeamanan, alamat, info, lng, type, sumber, lat, foto FROM keamanan WHERE idkeamanan =:uid');
	...
	{
		$namakeamanan = $_POST['namakeamanan'];// user name
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE keamanan 
									     SET namakeamanan=:unama, 
										     alamat=:ualamat, 
                                             info=:uinfo,  
										     type=:utype,  
										     lng=:ulng, 
										     ...
										     sumber=:usumber, 
										     foto=:ufoto 
								       WHERE idkeamanan=:uid');
			$stmt->bindParam(':unama',$namakeamanan);
	...
	?>
                ...
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Form Edit keamanan</h4>
                    <div class="row">
                      <form class="col s12" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <div class="input-field col s12">
                            <input id="nama" type="text" name="namakeamanan" value="<?php echo $namakeamanan;?>">
                            <label>Nama keamanan</label>
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                        ...
                        <div class="file-field input-field col s12">
	                        ...
	                        <img src="images/keamanan/<?php echo $foto; ?>" width="90px" height="90px" />
	                        <div class="btn">
	                          <span>Foto</span>
